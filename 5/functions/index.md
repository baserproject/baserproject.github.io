...
| 検索インデックス管理 | サイト内検索の対象コンテンツの優先度設定、検索インデックスへの追加・削除を行えます。 |

### ウィジェットエリア管理（BcWidgetArea）
